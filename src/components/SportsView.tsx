...
import { 
  ...
  Clock, Zap, Target, Dumbbell, LayoutGrid, Calculator,
  BookOpen, HelpCircle, ChevronRight
} from "lucide-react";
...
// 📊 MEGA CARTELERA DEPORTIVA (TODOS LOS DEPORTES Y JUEGOS)
const DEPORTES_PARLEY = {
  "Fútbol": {
    ligas: ["Champions League", "La Liga", "Premier League", "Serie A", "Liga FUTVE"],
    juegos: [
      { liga: "Champions League", t1: "Real Madrid", t2: "Man City", time: "03:00 PM", gana: "Local", alta_baja: "Alta 2.5", handicap: "-0.5", analisis: "Madrid en casa es letal en transiciones rápidas." },
      ...
      { liga: "Liga FUTVE", t1: "Caracas FC", t2: "Táchira", time: "05:00 PM", gana: "Empate", alta_baja: "Baja 2.0", handicap: "+0.5 Tách", analisis: "Clásico nacional de mucha fricción." }
    ]
  },
  "Béisbol": {
    ligas: ["MLB (USA)", "LVBP (VEN)"],
    juegos: [
      { liga: "MLB (USA)", t1: "Yankees", t2: "Red Sox", time: "07:05 PM", gana: "Local", alta_baja: "Alta 8.5", handicap: "RL -1.5", analisis: "Cole domina a Boston. El viento favorece a los bateadores." },
      { liga: "MLB (USA)", t1: "Dodgers", t2: "Padres", time: "10:10 PM", gana: "Local", alta_baja: "Baja 7.5", handicap: "RL -1.5", analisis: "Duelo de pitcheo élite. Ohtani será el factor clave." },
      { liga: "MLB (USA)", t1: "Braves", t2: "Mets", time: "07:20 PM", gana: "Local", alta_baja: "Alta 9.0", handicap: "RL -1.5", analisis: "Atlanta tiene la ofensiva más poderosa del mes." }
    ]
  },
  "Básquet": {
    ligas: ["NBA", "Euroliga"],
    juegos: [
      { liga: "NBA", t1: "Lakers", t2: "Warriors", time: "10:00 PM", gana: "Visitante", alta_baja: "Alta 232.5", handicap: "Warriors -2.5", analisis: "Curry vs LeBron. La banca de GSW llega más fresca." },
  ...
  "Hockey (NHL)": {
    ligas: ["NHL"],
    juegos: [
      { liga: "NHL", t1: "Bruins", t2: "Rangers", time: "07:30 PM", gana: "Local", alta_baja: "Baja 5.5", handicap: "-1.5", analisis: "Boston tiene la mejor defensa de la liga." }
    ]
  },
  "Fútbol Americano": {
    ligas: ["NFL", "NCAA"],
...
const HIPISMO_DATA = {
  "La Rinconada (VEN)": {
    "2026-03-29": {
      carreras: [
        ...
        { num: 10, valida: "6ta Válida", hora: "05:35 PM", fav: "EL GRAN BRICEÑO (09)", place: "CANDY CUMMINGS (04)", analisis: "Cierre complicado. Sugerimos asegurar con el favorito." }
      ],
      cuadroIA: [
  ...
  "Gulfstream Park (USA)": {
    "2026-03-25": {
      carreras: [
        { num: 1, valida: "Race 1 (Maiden)", hora: "12:10 PM", fav: "SPEEDY (01)", place: "MAGIC (05)", analisis: "Baja de lote drásticamente. Irad Ortiz es la clave." },
            ...
            <div className="bg-[#FFFCEB] border-4 border-slate-900 rounded-[3rem] p-6 md:p-10 shadow-[10px_10px_0px_0px_rgba(0,0,0,1)] space-y-8 animate-in zoom-in duration-500 text-slate-900 relative overflow-hidden">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                  <div className="bg-white border-4 border-slate-900 p-6 rounded-[2.5rem] shadow-xl flex flex-col justify-between">
                     <div><span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Juego</span><p className="font-black text-xl uppercase italic leading-none mt-1">{matches[0].t1} vs {matches[0].t2}</p></div>
                  ...
                  {matches[1] && (
                    <div className="bg-white border-4 border-slate-900 p-6 rounded-[2.5rem] shadow-xl flex flex-col justify-between">
                       <div><span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Juego</span><p className="font-black text-xl uppercase italic leading-none mt-1">{matches[1].t1} vs {matches[1].t2}</p></div>
