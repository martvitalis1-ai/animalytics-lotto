...
export function SportsView() {
  const games = [
    ...
    { league: "EUROPA", match: "MADRID vs CITY", line: "Gana/Empata", pick: "MADRID" }
  ];
    ...
    <div className="space-y-8 animate-in fade-in duration-700 pb-40">
      <div className="bg-slate-900 text-white p-10 rounded-[4rem] border-b-8 border-orange-500 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-8">
           ...
           <div><h2 className="text-3xl font-black uppercase italic leading-none">Las Vegas Sync</h2><p className="text-orange-400 font-bold mt-2 uppercase text-xs">Sincronización Mundial Real</p></div>
        </div>
      </div>
