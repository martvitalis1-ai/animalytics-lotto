...
const DEPORTES_PARLEY = {
  ...
  "Béisbol": {
    ...
    juegos: [
      { liga: "MLB (USA)", t1: "Yankees", t2: "Red Sox", time: "07:05 PM", gana: "Local", alta_baja: "Alta 8.5", handicap: "RL -1.5", analisis: "Gerrit Cole domina a Boston históricamente." },
  ...
  "La Rinconada (VEN)": {
    "2026-03-29": {
      carreras: [
        ...
        { num: 6, valida: "2da Válida", hora: "03:45 PM", fav: "AMELIARE (07)", place: "TURQUESA (02)", analisis: "Speed rating superior al lote." },
  ...
  "Gulfstream Park (USA)": {
    "2026-03-25": {
      carreras: [
        ...
        { num: 4, valida: "Race 4 (Pick 6)", hora: "02:40 PM", fav: "GLOBAL SENSATION (02)", place: "SPEEDY BOY (06)", analisis: "Pletcher tiene 42% de efectividad aquí." }
      ],
      cuadroIA: [
