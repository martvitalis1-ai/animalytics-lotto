      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_450px] gap-10">
        <div className="bg-white border-4 border-slate-900 rounded-[3rem] p-10 shadow-xl space-y-10">
          ...
          <div className="space-y-10">
             <div className="p-8 bg-slate-50 rounded-[3rem] border-4 border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6">
                <span className="font-black text-2xl italic uppercase text-slate-800">Real Madrid vs Man City</span>
                <div className="w-full md:w-64 h-5 bg-slate-200 rounded-full overflow-hidden flex border-2 border-white shadow-inner">
