...
// 🛡️ EXPORTACIÓN AGREGADA PARA QUE EL BUILD NO FALLE
export function Dashboard({ userRole, onLogout, tenantAgency }: any) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans antialiased">
      ...
      {/* HEADER: SELECTOR SIN LOGO (RÁPIDO Y LIMPIO) */}
      <header className="sticky top-0 z-[100] bg-slate-900 text-white border-b-4 border-emerald-500 px-4 py-3 shadow-2xl">
        <div className="max-w-7xl mx-auto flex justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-2 flex-1 justify-end">
            ...
            <Button variant="ghost" onClick={onLogout} className="text-white p-1 hover:bg-red-500 rounded-full">
              <LogOut size={20} />
            </Button>
          </div>
        </div>
