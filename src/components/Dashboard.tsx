          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="bg-white border-4 border-slate-900 rounded-2xl p-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              <Select value={globalLottery} onValueChange={setGlobalLottery}>
                <SelectTrigger className="w-64 h-12 border-none font-black uppercase text-xs">
                  <SelectValue />
                </SelectTrigger>
            ...
            <TabsList className="bg-white p-1 rounded-full h-14 border-2 border-slate-900 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex overflow-x-auto no-scrollbar w-full md:w-auto">
              <TabsTrigger value="ia" className="rounded-full px-5 font-black text-[10px] uppercase data-[state=active]:bg-emerald-600 data-[state=active]:text-white flex-1">IA</TabsTrigger>
              ...
              <TabsTrigger value="deportes" className="rounded-full px-5 font-black text-[10px] uppercase data-[state=active]:bg-slate-900 data-[state=active]:text-white flex-1">Deportes</TabsTrigger>
              <TabsTrigger value="resultados" className="rounded-full px-5 font-black text-[10px] uppercase data-[state=active]:bg-slate-900 data-[state=active]:text-white flex-1">Resultados</TabsTrigger>
              <TabsTrigger value="matriz" className="rounded-full px-5 font-black text-[10px] uppercase data-[state=active]:bg-slate-900 data-[state=active]:text-white flex-1">Matriz</TabsTrigger>
              <TabsTrigger value="guia" className="rounded-full px-5 font-black text-[10px] uppercase data-[state=active]:bg-emerald-500 data-[state=active]:text-white flex-1">Guía</TabsTrigger>
              <TabsTrigger value="agencias" className="rounded-full px-5 font-black text-[10px] uppercase data-[state=active]:bg-emerald-600 data-[state=active]:text-white flex-1">Agencias</TabsTrigger>
