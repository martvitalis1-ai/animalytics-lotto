    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans antialiased">
      ...
      <main className="p-4 max-w-7xl mx-auto pb-20">
        <Tabs value={activeTab} className="space-y-8">
          ...
          <TabsContent value="deportes" className="p-20 text-center border-4 border-slate-900 rounded-[3rem] bg-white"><Trophy size={60} className="mx-auto text-slate-200" /><h3 className="font-black uppercase italic text-2xl mt-4 text-slate-400">Sincronizando Las Vegas...</h3></TabsContent>
        </Tabs>
      </main>
    </div>
  );
