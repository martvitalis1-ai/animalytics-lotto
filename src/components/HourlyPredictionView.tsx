        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-900 p-8 rounded-[3rem] border-b-8 border-emerald-500 shadow-2xl text-white relative overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                ...
                <div className="text-center md:text-left flex-1">
                  ...
                  <h2 className="text-2xl lg:text-3xl font-black italic uppercase leading-none mt-1">LA IA SUGIERE: {stats.recommendation}</h2>
                  <p className="text-sm mt-2 font-medium text-slate-300">Máximo potencial: <span className="text-emerald-400 font-black underline">{stats.bestHours[0]?.time || "---"}</span></p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-900 p-8 rounded-[3.5rem] text-white shadow-2xl border-b-8 border-emerald-500">
              <h4 className="font-black text-xs uppercase text-emerald-400 mb-8 flex items-center gap-2 tracking-widest"><Clock size={16} /> Horarios de Poder</h4>
              ...
              <h4 className="font-black text-xs uppercase text-emerald-400 mt-12 mb-8 italic flex items-center gap-2 tracking-widest"><Calendar size={16} /> Días de Acierto</h4>
              <div className="space-y-4">
