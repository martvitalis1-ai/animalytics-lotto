...
export function HourlyPredictionView({ lotteryId }: { lotteryId: string }) {
  ...
  if (!data) return <div className="p-20 text-center font-black animate-pulse text-emerald-500 uppercase">Estudiando Sorteo...</div>;
    ...
    <div className="space-y-12 animate-in fade-in duration-700 pb-20">
      ...
      <div className="bg-slate-50 border-4 border-slate-900 p-10 rounded-[4rem] shadow-2xl">
        ...
        <div className="flex justify-around items-center gap-6 flex-wrap">
           {['12', '00', '31'].map(code => (
             <div key={code} className="flex flex-col items-center bg-white p-6 rounded-[3rem] border-2 border-slate-200 shadow-md">
