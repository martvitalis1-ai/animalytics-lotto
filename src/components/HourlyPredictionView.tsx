...
import { Zap, Clock, RefreshCw, Loader2 } from "lucide-react";
    ...
    <Card className="glass-card border-2 border-primary/20 shadow-2xl overflow-hidden p-6 text-center bg-white rounded-[3rem]">
      ...
      {pred?.topPick ? (
        <div className="flex flex-col items-center animate-in zoom-in duration-500">
          ...
          <div className="mt-6 inline-flex items-center gap-2 px-10 py-4 bg-emerald-600 text-white rounded-3xl font-black text-2xl shadow-xl border-b-4 border-emerald-800">
        ...
        <div className="py-20 flex flex-col items-center opacity-30">
          ...
          <p className="font-black uppercase tracking-widest text-xs">Cargando Búnker...</p>
        </div>
      )}
    </Card>
  );
