...
export function HourlyPredictionView({ lotteryId }: { lotteryId: string }) {
  ...
  useEffect(() => {
    const updateStudy = () => {
      ...
      // Reinicio Maestra: Si es después de las 8 PM, ya prepara el estudio de mañana
    ...
    async function load() {
      // 🛡️ Filtro real de historial (Sincroniza Granjita, Rey, etc.)
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700 pb-20">
      {/* ANIMAL MAESTRO GIGANTE CON TU LOGO DE FONDO */}
