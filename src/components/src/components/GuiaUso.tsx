    ...
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-6">
      <Card className="glass-card border-2 border-primary/30 overflow-hidden shadow-2xl rounded-[2rem]">
        <CardHeader className="bg-muted/10 border-b border-primary/10 py-6 text-center">
          <CardTitle className="flex items-center justify-center gap-3 text-2xl font-black uppercase italic text-primary">
        ...
        <CardContent className="p-0">
          <div className="aspect-video bg-black w-full flex items-center justify-center border-b-2 border-primary/10">
            {data?.video_url ? (
              <video controls className="w-full h-full object-contain"><source src={data.video_url} type="video/mp4" /></video>
            ) : (
              <p className="text-muted-foreground uppercase font-black text-xs">Esperando carga de video...</p>
            )}
          </div>
          <div className="p-8 space-y-4">
            <div className="flex items-center gap-2 text-primary font-black uppercase tracking-widest text-xs"><BookOpen className="w-4 h-4" /> Instrucciones</div>
