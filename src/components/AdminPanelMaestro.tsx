...
export const getDrawTimesForLottery = (lotteryId: string) => {
  // Todas estas loterías comparten el mismo bloque de horarios militares
  return [
...
// Funciones de apoyo que usan las matrices para no fallar
