...
export function ModuloJugadas() {
  ...
  // ✅ IA CON SEGURO ANTI-CONGELAMIENTO
  const cargarDatoIA = async () => {
    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        // Fallback si no hay datos en la DB
                   ...
                   {isVip ? (
                     iaLoading ? (
                        <div className="flex flex-col items-center gap-4 py-10">
                           ...
                           <p className="font-black uppercase tracking-widest text-emerald-500">Analizando jugadas...</p>
                        </div>
                     ) : (
                     ...
                     <div className="flex flex-col items-center gap-8 text-center">
                        ...
                        <div className="w-full max-w-sm flex flex-col gap-4">
                           ...
                           <Button onClick={() => { if(passVip.toUpperCase() === 'VIP-BUNKER') { setIsVip(true); localStorage.setItem('vip_active', 'true'); } }} className="bg-emerald-500 text-slate-900 rounded-2xl font-black h-16 uppercase">ACTIVAR ACCESO</Button>
                        </div>
                     </div>
                   )}
                </div>
