                   ...
                   {isVip ? (
                     iaLoading ? (
                        <div className="flex flex-col items-center gap-4 py-10 opacity-50 text-emerald-500">
                           ...
                           <p className="font-black uppercase tracking-widest text-sm italic">Analizando patrones...</p>
                        </div>
                     ) : (
                        <div className="space-y-6 animate-in zoom-in-95 duration-700">
                           <div className="text-6xl lg:text-8xl font-black tracking-tighter flex flex-col items-center gap-4 leading-none text-center">
                              ...
                              <div className="relative w-32 h-32 lg:w-48 lg:h-48">
                                <img src={`${ANIMAL_IMG_BASE}${datoVip?.animal_id}.png`} className="w-full h-full object-contain relative z-10" alt="VIP" crossOrigin="anonymous" onError={(e) => (e.currentTarget.style.display = 'none')} />
                                <span className="absolute inset-0 flex items-center justify-center text-6xl opacity-20">{ANIMAL_EMOJIS[datoVip?.animal_id]}</span>
                              </div>
                     ...
                     <div className="flex flex-col items-center gap-8 text-center">
                        ...
                        <div className="w-full max-w-sm flex flex-col gap-4">
                           <Button onClick={() => window.open('https://t.me/+1NfML7kPFeliNDE5', '_blank')} className="w-full h-16 bg-[#229ED9] hover:bg-[#1e8ec5] text-white font-black uppercase rounded-2xl shadow-xl flex items-center justify-center gap-3 text-center"><Send size={24} className="fill-white"/> VER EN TELEGRAM</Button>
            ...
            <div className="grid grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-3 text-center">
              {filteredNumbers.map(n => (
                <button key={n} onClick={() => setSelectedNum(n)} className={`flex flex-col items-center justify-center p-3 rounded-[2rem] border-2 transition-all h-32 lg:h-48 ${selectedNum === n ? 'border-emerald-500 bg-emerald-50 shadow-inner scale-110 z-10' : 'bg-[#F8FAFC] border-transparent text-slate-600 hover:bg-slate-200'}`}>
                  {/* IMAGEN BLING-BLING 3D */}
                  <div className="w-16 h-16 lg:w-24 lg:h-24 mb-1 relative flex items-center justify-center">
                    <img src={`${ANIMAL_IMG_BASE}${n}.png`} className="w-full h-full object-contain z-10 relative" alt={n} crossOrigin="anonymous" onError={(e) => (e.currentTarget.style.display = 'none')} />
                    <span className="absolute inset-0 flex items-center justify-center text-3xl opacity-20 grayscale">{ANIMAL_EMOJIS[n]}</span>
                  </div>
        ...
        <div className="space-y-8 flex flex-col items-center w-full text-slate-900 text-center">
          <div className="lg:sticky lg:top-10 space-y-8 w-full text-center">
            ...
            <div className="bg-white p-8 lg:p-12 font-mono shadow-2xl rounded-[4rem] border-t-[18px] border-emerald-600 min-h-[500px] flex flex-col text-slate-900">
              ...
              <div className="mt-4 mb-6 p-4 bg-slate-50 border border-slate-200 rounded-3xl text-center">
                <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2 italic flex items-center justify-center gap-1">
                ...
                <p className="text-[10px] leading-tight text-slate-500 font-medium">
                  El compromiso de pago y cobro es <span className="text-emerald-600 font-bold">exclusivo entre usted y la agencia</span>. Animalytics Pro no gestiona fondos.
                </p>
              </div>
      ...
      {selectedAgencia?.publicidad_url && (
        <div className="max-w-[1600px] w-full mx-auto mt-24 px-6 pb-40 text-center flex flex-col items-center">
           ...
           <div className="relative w-full group">
             <img src={selectedAgencia.publicidad_url} alt="Publicidad Agencia" className="w-full h-auto object-contain max-h-[800px] mx-auto rounded-[4rem] lg:rounded-[5.5rem] shadow-2xl border-[8px] lg:border-[16px] border-white bg-white transition-transform duration-700 group-hover:scale-[1.01]" crossOrigin="anonymous" />
