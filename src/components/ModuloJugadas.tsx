...
import { Send, Trash2, Wallet, Landmark, CheckCircle2, Instagram, MessageCircle, Plus, Star, Key, Lock, Loader2, Calculator } from "lucide-react";
                   ...
                   {isVip ? (
                     iaLoading ? (
                        <div className="flex flex-col items-center gap-4 py-10 opacity-50 text-emerald-500">
                           ...
                           <p className="font-black uppercase tracking-widest text-sm">Procesando Malicia...</p>
                        </div>
                     ) : (
                        <div className="space-y-6 animate-in zoom-in-95 duration-700">
                           ...
                           <div className="flex flex-wrap justify-center gap-3">
                              <span className="bg-emerald-500/20 text-emerald-400 px-5 py-2 rounded-2xl font-black text-sm uppercase italic">🎯 {datoVip?.metodo || "Matemática"}</span>
                     ...
                     <div className="flex flex-col items-center gap-8 text-center text-slate-900">
                        ...
                        <div className="w-full max-w-sm flex flex-col gap-4 text-center">
                           <Input value={passVip} onChange={e => setPassVip(e.target.value)} placeholder="Código VIP..." className="bg-white/5 border-white/10 text-white font-black text-center text-lg h-14 rounded-2xl placeholder:text-white/20" />
              ...
              <div className="flex-1 space-y-5 overflow-y-auto max-h-[350px] no-scrollbar text-center text-slate-900">
                {currentJugadas.map((j, i) => (
                  <div key={i} className="border-b border-slate-50 pb-5 flex flex-col items-center justify-center text-slate-900">
                    ...
                    <p className="font-black text-xl italic text-slate-800 leading-none text-center text-slate-900">#{j.numero} - {j.animal}</p>
