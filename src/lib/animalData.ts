...
// UPDATED: 16/02/2026 - Full 00-99 Dictionary Implementation
// Corrected based on user official list (77=Pingüino, 88=Erizo, 95=Escarabajo, etc.)
// ============================================================
...
// GUACHARITO (0, 00 to 99) - FULL CORRECTED LIST
...
function getCategoryForAnimal(name: string): string {
  const categories: Record<string, string[]> = {
    acuatico: ['DELFÍN', 'BALLENA', 'RANA', 'PESCADO', 'TIBURÓN', 'PULPO', 'CANGREJO', 'ANGUILA', 'CABALLITO DE MAR', 'ERIZO DE MAR', 'CALAMAR', 'CISNE'],
    ...
    silvestre: ['LAPA', 'ARDILLA', 'VENADO', 'CHIGÜIRE', 'PUERCOESPÍN', 'PEREZA', 'OSO HORMIGUERO', 'CACHICAMO', 'MURCIÉLAGO', 'HURÓN', 'HÁMSTER'],
