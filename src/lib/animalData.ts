...
export const ANIMALS_GUACHARO: Record<string, string> = { ...ANIMALS_STANDARD, '75': 'GUÁCHARO' };
export const ANIMALS_GUACHARITO: Record<string, string> = { ...ANIMALS_GUACHARO, '99': 'GUACHARITO' };
