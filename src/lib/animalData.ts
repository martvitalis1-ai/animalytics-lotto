// ============================================================
// ANIMAL DATA PRO - Versión Final Blindada (0-99)
// ============================================================
...
// MAPEADO OFICIAL VENEZUELA (00-99)
...
export const getAnimalByCode = (code: string): AnimalInfo | undefined => {
  ...
  // Caso especial 00 y 0
  const name = ANIMALS_MAESTRO_MAP[norm] || ANIMALS_MAESTRO_MAP[parseInt(norm).toString()] || "ANIMAL";
  return { id: parseInt(norm) || 0, code: norm, name: name, category: "general" };
};
...
export const getAnimalName = (code: string): string => {
  return getAnimalByCode(code)?.name || "ANIMAL";
};
