...
// RUTA EXACTA DE TU BUCKET EN SUPABASE (Mayúsculas respetadas)
const SUPA_BUCKET = "https://qfdrmyuuswiubsppyjrt.supabase.co/storage/v1/object/public/ANIMALITOS/";

export const getAnimalImageUrl = (code: string | number): string => {
  const strCode = String(code).trim();
  // Blindaje: 0 y 00 quedan igual, del 1 al 9 les pone el 0 (01, 02...)
  const normalized = (strCode === '0' || strCode === '00') ? strCode : strCode.padStart(2, '0');
  return `${SUPA_BUCKET}${normalized}.png`;
};
