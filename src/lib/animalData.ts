// ============================================================
// ANIMAL DATA - VERSIÓN CORREGIDA v106.5 (A MAYÚSCULA)
// ============================================================
...
// RUTA EXACTA SEGÚN TU CAPTURA (Carga de Animales)
...
export const ANIMAL_EMOJIS: Record<string, string> = {
  ...
  "23": "🦓", "24": "🦎", "25": "🐔", "26": "🐄", "27": "🐕", "28": "Zamuro", "29": "🐘", "30": "🐊", 
...
export const getAnimalByCode = (code: string | number) => {
  ...
  const strCode = String(code).trim();
  const normalized = (strCode === '0' || strCode === '00') ? strCode : strCode.padStart(2, '0');
  const name = getAnimalName(normalized);
